...
public:
	enum BlockType {
		...
		BLOCK_TORCH, BLOCK_TORCH_R0, BLOCK_TORCH_R90, BLOCK_TORCH_R180, BLOCK_TORCH_R270, BLOCK_COBBLESTONE, BLOCK_WOOD, BLOCK_WHEAT, BLOCK_COUNT
	};

	//this should be in opposite order
	enum BlockTextures {
		WHEAT, COBBLESTONE, WOOD, DANDELION, POPPY, CYAN_FLOWER, FOILAGE, ELM_SIDE, ELM_TOP, BIRCH_SIDE, BIRCH_TOP, WATER, GRANITE, SNOW, SNOW_SIDE, SAND, GRASS_TOP, GRASS_SIDE, DIRT, NONE
	};
